...
mixin _$FavoritesState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<FavoriteItem> items) loaded,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<FavoriteItem> items)? loaded,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<FavoriteItem> items});
}
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<FavoriteItem> items) : _items = items;
...
abstract class _Loaded implements FavoritesState {
  const factory _Loaded(final List<FavoriteItem> items) = _$LoadedImpl;
