...
/// حقل إدخال بشكل كبسولة (Pill) بنفس تصميم الصورة.
/// - رمادي فاتح، بدون حدود، زوايا دائرية جدًا.
/// - ارتفاع صغير ومتناسق مع التصميم.
/// - يدعم أرقام/نص، مع inputFormatters اختيارية.
/// - مثالي لحقول مثل: Floor number, Door number.
